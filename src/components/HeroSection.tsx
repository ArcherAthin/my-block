          ...
          >
            <div className="space-y-4">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold text-white leading-tight tracking-wide">
                My <span className="bg-gradient-to-r from-[#ff6ec4] to-[#7873f5] bg-clip-text text-transparent">Block</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                ...
                className="bg-gradient-to-r from-[#ff6ec4] to-[#7873f5] hover:scale-105 transition-all duration-300 text-white font-medium tracking-wide shadow-xl text-lg px-8 py-6 rounded-xl border-0 hover:shadow-2xl hover:text-white"
              >
              ...
              <Button 
                ...
                variant="outline" 
                className="border-white/30 text-white hover:bg-white/10 backdrop-blur-md transition-all duration-300 text-lg px-8 py-6 rounded-xl hover:border-white/50 hover:text-white bg-transparent"
              >
            ...
            {showDemoAlert && (
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 text-white">
                <p className="text-sm">🎬 Demo video coming soon! This platform showcases the full MyBlock experience.</p>
              </div>
            )}
